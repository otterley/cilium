...
type CiliumNodeLabelsUpdater = K8sWatcher
...
func (k *K8sWatcher) updateCiliumNodeLabels(node *v1.Node) {
	var (
		nodeName   = node.Name
	...
	k8sCM.UpdateController(controllerName,
		controller.ControllerParams{
			DoFunc: func(ctx context.Context) (err error) {
				...
				ciliumNodeInterface, exists, err := k.ciliumNodeStore.GetByKey(nodeName)
				if err != nil {
